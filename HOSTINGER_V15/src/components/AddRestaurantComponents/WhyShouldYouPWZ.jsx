...
let WhyShouldYouPWZ = () => {
    return <div className={css.outerDiv}>
        <div className={css.innerDiv}>
            <div className={css.title}>Why should you partner with FoodRiders?</div>
            <div className={css.tagLine}>FoodRiders enables you to get 60% more revenue, 10x new customers and boost your brand visibility by providing insights to improve your business.</div>
