...
const sendPushNotification = async (token, title, body, data = {}) => {
    ...
    // HARD FIX: On Android, if we send a 'notification' object, the OS handles it in background.
    // If we want our Service to handle it and play the Siren LOOP, we MUST send 'data' only.
    const message = {
        data: {
            ...stringData,
            title: title,
    ...
    // Only add the notification block for NON-CRITICAL alerts
    if (!isOrderAlert) {
