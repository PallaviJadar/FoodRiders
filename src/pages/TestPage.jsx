...
import CheckBoxUtil from '../utils/FormUtils/CheckBoxUtil.jsx'

import OverviewAboutCard from '../utils/Cards/RestaurantBodyCards/OverviewAboutCard.jsx'
import SmallSearchBarUtil from '../utils/RestaurantUtils/SmallSearchBarUtil.jsx'
import RateYourExperienceCard from '../utils/Cards/RestaurantBodyCards/RateYourExperienceCard.jsx'
import RedBtnHovWithIcon from '../utils/Buttons/RedBtnHovWithIcon.jsx'
...
import OfferTrackUtil from '../utils/RestaurantUtils/OfferTrackUtil.jsx'
import LabelUtil from '../utils/RestaurantUtils/LabelUtil.jsx'
import MenuCard from '../utils/Cards/RestaurantBodyCards/MenuCard.jsx'
import FoodItemProduct from '../utils/RestaurantUtils/FoodItemProduct.jsx'

import CarouselUtil from '../utils/CarouselUtil.jsx'
...
import GoTopArrow from '../utils/GoTopArrow.jsx'
...
const TestPage = () => {
  ...
  return <div>
    ...
    <div style={{ display: "flex" }}>
      <MenuCard ttl="Food Menu" imgSrc={'/images/food1.jpg'} pages="23" />
      <MenuCard ttl="Food Menu" imgSrc={'/images/food1.jpg'} pages="23" />
    </div>
