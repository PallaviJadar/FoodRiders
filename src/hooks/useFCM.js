...
const useFCM = () => {
    ...
    const setupMessaging = useCallback(async () => {
        // 🔥 CRITICAL: Don't request Web FCM Tokens in Native Android/iOS App
        // Web Push doesn't work when the app is closed, and it causes token confusion.
        if (typeof window !== 'undefined' && window.Capacitor && window.Capacitor.isNativePlatform()) {
            console.log('[useFCM] Native platform detected. Skipping Web FCM init in favor of Native Push.');
            return;
        }
