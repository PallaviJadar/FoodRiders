...
import RedBtnHov from '../utils/Buttons/RedBtnHov.jsx' 
import WhiteBtnHov from '../utils/Buttons/WhiteBtnHov.jsx' 
import TextUtil from '../utils/FormUtils/TextUtil.jsx'
import TextUtilWithCancel from '../utils/FormUtils/TextUtilWithCancel.jsx'
import EnterOTP from '../components/Auth/EnterOTP.jsx'
            ...
            <div className={css.bdy}>
                ...
                >{(formik) => {
                    return <Form className={css.form}>
                        ...
                        <span className={css.formTxt}>You can update your phone number using the FoodRiders app</span>
